...
public interface UserMapper {
	...
	// define the list of object in User class itself and use the getter
	// property to retrieve its value
	/*
	 ...
	 * + ")}")
	 * 
	 * @Options(statementType = StatementType.CALLABLE) Object
	 * getAllUserUsingAnnotation(User user);
	 */
}